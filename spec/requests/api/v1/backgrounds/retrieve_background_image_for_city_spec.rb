...
RSpec.describe "Get Background Image for City Endpoint" do
  it "can get backgrounds for a city" do
    ...
    expect(background_json[:data][:attributes][:credit].size).to eq(3)
